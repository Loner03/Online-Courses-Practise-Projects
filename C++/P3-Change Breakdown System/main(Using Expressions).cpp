...
int main() {
	...
	Balance = Amount - (Dollars * Dollar_To_Cents);

	int Quarters;
	Quarters = Balance / Quarters_To_Cents;
	Balance = Balance - (Quarters * Quarters_To_Cents);

	int Dimes;
	Dimes = Balance / Dimes_To_Cents;
	Balance = Balance - (Dimes * Dimes_To_Cents);

	int Nickles;
	Nickles = Balance / Nickle_To_Cents;
	Balance = Balance - (Nickles * Nickle_To_Cents);

	int Pennies;
	Pennies = Balance / Pennie_To_Cents;
